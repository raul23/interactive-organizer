"""setup.py file for the ``interactive_organizer`` package.
"""
import fnmatch
import os
import sys
...
from interactive_organizer import __version__, __test_version__

if sys.version_info < (3, 6, 9):
    raise RuntimeError("""
    interactive_organizer v0.1.0+ supports Python 3.6.9 and above.
    """)
...
setup(name='interactive-organizer',
      version=VERSION,
      description='''Interactively and manually organize ebook files quickly.''',
      ...
      keywords='calibre djvu ebook epub interactive isbn ocr organizer pdf script',
      url='https://github.com/raul23/interactive-organizer',
      author='Raul C.',
